...
//namespace Rendering
//{
//	const vec4 CityGMLModeler::DefaultColor = vec4(0.961f, 0.871f, 0.702f, 1.0f);
//	CityGMLModeler::CityGMLModeler(Game& game, Camera& camera)
...
//	}
//
//	void CityGMLModeler::Initialize()
//	{
//		//Axes in 3D
...
//	}
//
//	void CityGMLModeler::Draw(const GameTime& gameTime)
//	{
//		if (mShapeType == SHPT_POINT)
//		{
//			glBindVertexArray(mVertexArrayObject);
...
//	}
//
//	void CityGMLModeler::CreateVertexBuffer(const Mesh& mesh, GLuint& vertexBuffer)
//	{
...
//	}
//
//	void CityGMLModeler::CreateVertexBuffer(const pcl::PointCloud<pcl::PointXYZRGBNormal>& cloud, GLuint& vertexBuffer)
//	{
//		//const std::vector<vec3>& sourceVertices = mesh.Vertices();
...
//	void CityGMLModeler::CreateVertexBuffer(const pcl::PointCloud<pcl::PointXYZ>& cloud,
