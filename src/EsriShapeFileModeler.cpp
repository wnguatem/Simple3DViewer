...
//namespace Rendering
//{
//	const vec4 EsriShapeFileModeler::DefaultColor = vec4(0.961f, 0.871f, 0.702f, 1.0f);
//	EsriShapeFileModeler::EsriShapeFileModeler(Game& game, Camera& camera)
...
//	}
//
//	EsriShapeFileModeler::~EsriShapeFileModeler()
//	{
//
...
//
//
//	void EsriShapeFileModeler::Initialize()
//	{
//
//		//Axes in 3D
...
//	}
//
//	void EsriShapeFileModeler::Draw(const GameTime& gameTime)
//	{
//		if (mShapeType == SHPT_POINT)
//		{
//			glBindVertexArray(mVertexArrayObject);
...
//	}
//
//	void EsriShapeFileModeler::CreateVertexBuffer(const Mesh& mesh, GLuint& vertexBuffer)
//	{
...
//	}
//
//	void EsriShapeFileModeler::CreateVertexBuffer(const pcl::PointCloud<pcl::PointXYZRGBNormal>& cloud, GLuint& vertexBuffer)
//	{
//		//const std::vector<vec3>& sourceVertices = mesh.Vertices();
...
//	void EsriShapeFileModeler::CreateVertexBuffer(const pcl::PointCloud<pcl::PointXYZ>& cloud,
