...
#ifndef _Quad_Modeler_H_
#define _Quad_Modeler_H_
...
namespace Rendering
{
    class QuadModeler : public DrawableGameComponent
    {
        
    public:
        QuadModeler(Game& game, Camera& camera);
    ...
    private:
        ...
        QuadModeler();
        QuadModeler(const QuadModeler& rhs);
        QuadModeler& operator=(const QuadModeler& rhs);
