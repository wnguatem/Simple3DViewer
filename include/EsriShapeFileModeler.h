...
#ifndef _EsriShape_File_Modeler_H_
#define _EsriShape_File_Modeler_H_
...
namespace Rendering
{
	class EsriShapeFileModeler : public DrawableGameComponent
	{

	public:
		EsriShapeFileModeler(Game& game, Camera& camera);

		~EsriShapeFileModeler();
	...
	private:
		...
		EsriShapeFileModeler();
		EsriShapeFileModeler(const EsriShapeFileModeler& rhs);
		EsriShapeFileModeler& operator=(const EsriShapeFileModeler& rhs);
...
#endif//_EsriShape_File_Modeler_H_